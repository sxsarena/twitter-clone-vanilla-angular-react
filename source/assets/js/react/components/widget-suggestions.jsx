      ...
      <section className="widgetWhoToFollow">
        ...
        <div className="widgetWhoToFollow-body">
          <ul className="widgetWhoToFollow-list">
            <li className="widgetWhoToFollow-item">
              <img className="widgetWhoToFollow-image" src="https://pbs.twimg.com/profile_images/664406672132149248/2BU5uSTT_normal.jpg" alt="" width="48" height="48" />
              <a className="widgetWhoToFollow-link">
                <strong className="widgetWhoToFollow-fullname">Minas Testing Conf</strong>
                <span className="widgetWhoToFollow-username">@minas...</span>
              </a>
              <small className="widgetWhoToFollow-followed">
                Followed by <a className="widgetWhoToFollow-followed-link">Leonardo A. So...</a>
              </small>
